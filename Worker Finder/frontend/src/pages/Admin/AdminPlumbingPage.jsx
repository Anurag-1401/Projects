...
const AdminPlumbingPage = () => {
    ...
    if ("geolocation" in navigator) {
        navigator.geolocation.getCurrentPosition(async (position) => {
            ...
            try {
                ...
                const response = await axios.get(`${baseURL}/api/getplumber/${adminId}`, {
  ...
  const handleAddWorker = async () => {
    if ("geolocation" in navigator) {
        navigator.geolocation.getCurrentPosition(async (position) => {
            ...
            try {
                const response = await axios.post(`${baseURL}/api/addplumber`, {
                    ...newWorker,
  ...
  const handleDeleteWorker = async (id) => {
    try {
      await axios.delete(`${baseURL}/api/deleteplumber/${id}`);
