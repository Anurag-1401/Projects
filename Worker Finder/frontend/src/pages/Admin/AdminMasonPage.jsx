...
const AdminMasonPage = () => {
  ...
  const user = useSelector((state) => state.auth.user);
      ...
      if ("geolocation" in navigator) {
          navigator.geolocation.getCurrentPosition(async (position) => {
              ...
              try {
                  ...
                  const response = await axios.get(`${baseURL}/api/getmason/${adminId}`, {
    ...
    const handleAddWorker = async () => {
      if ("geolocation" in navigator) {
          navigator.geolocation.getCurrentPosition(async (position) => {
              ...
              try {
                  const response = await axios.post(`${baseURL}/api/addmason`, {
                      ...newWorker,
    ...
    const handleDeleteWorker = async (id) => {
      try {
        await axios.delete(`${baseURL}/api/deletemason/${id}`);
  ...
  return (
    <div className="admin-page">
      ...
      <div className="admin-container">
        <div className="heading">Manage Masons</div>
      ...
      <div className="list-container">
        <h2 className="heading">List of Masons</h2>
        <div className="line"></div>
        ...
        {workers.length > 0 ? (
          <table className="worker-table">
            ...
            <tbody className='body'>
              ...
              <p className="admin-no-workers">No Masons available.</p>
            )}
          </div>
    
          <img className="img" src={MasonI} alt="Plumber" />
