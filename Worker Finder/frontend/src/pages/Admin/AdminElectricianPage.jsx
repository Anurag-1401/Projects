...
import E from '../../logos/istockphoto-1354891373-612x612.jpg'
...
const AdminElectricianPage = () => {
  ...
  const [errors,seterrors] = useState('');
      ...
      if ("geolocation" in navigator) {
          navigator.geolocation.getCurrentPosition(async (position) => {
              ...
              try {
                  ...
                  const response = await axios.get(`${baseURL}/api/getelectrician/${adminId}`, {
    ...
    const handleAddWorker = async () => {
      if ("geolocation" in navigator) {
          navigator.geolocation.getCurrentPosition(async (position) => {
              ...
              try {
                  const response = await axios.post(`${baseURL}/api/addelectrician`, {
                      ...newWorker,
    ...
    const handleDeleteWorker = async (id) => {
      try {
        await axios.delete(`${baseURL}/api/deleteelectrician/${id}`);
  ...
  return (
    <div className="admin-page">
      ...
      <div className="admin-container">
        <div className="heading">Manage Electricians</div>
        <div className="line"></div>

        <div className="add">
          <h3>Add New Electrician</h3>
      ...
      <div className="list-container">
        <h2 className="heading">List of Electricians</h2>
        <div className="line"></div>
              ...
              {workers.map((worker, index) => (
                <tr key={index}>
                  ...
                  <img className='navi' src={Navi} alt="" onClick={()=>opencard(worker)} />
                        ...
                        <img className="img" src={E} alt="Plumber" />
