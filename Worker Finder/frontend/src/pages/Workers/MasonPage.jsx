...
const fetchWorkers = async () => {
  ...
  try {
    const response = await axios.get(`${baseURL}/api/getmason/all`, {
...
try {
  await axios.post(`${baseURL}/api/ratemason/${workerId}`, { rating: selectedRating });
        ...
        <tbody>
          {workers.map((mason, index) => (
            <tr key={index} className="worker card">
              ...
              <td>
                <img className='navi' src={Navi} alt="" onClick={()=>opencard(mason)} />
