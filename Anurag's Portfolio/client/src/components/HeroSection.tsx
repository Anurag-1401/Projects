...
<div className="absolute inset-0">
    ...
    <div className="absolute top-1/2 left-1/2 w-full h-96 bg-purple-500/10 rounded-full blur-3xl"></div>
      ...
      hover:rotate-[10deg] overflow-hidden shadow-lg  hover:scale-110 transition-transform duration-300">
    ...
    <section id="home" className="flex flex-col items-center justify-center relative overflow-hidden">
      ...
      {[profileData].map((profile,index)=>(
        <div key={index} className="container mx-auto px-4 text-center relative z-10 max-w-2xl md:max-w-4xl">
        ...
        >
          ...
          <motion.h1
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
            className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-300 via-purple-200 to-pink-200 bg-clip-text text-transparent"
          >
            {profile.name}
          </motion.h1>
          </div>
          ...
          <motion.div
            ...
            >
            <a href={profile.github} target="_blank" className="text-white hover:text-blue-400 transition-colors duration-300 transform hover:scale-110">
              <Github className="w-6 h-6" />
            </a>
            <a href={profile.linkedin} target="main" className="text-white hover:text-blue-400 transition-colors duration-300 transform hover:scale-110">
              <Linkedin className="w-6 h-6" />
            </a>
            <a href={`mailto:${profile.email}`} className="text-white hover:text-blue-400 transition-colors duration-300 transform hover:scale-110">
              <Mail className="w-6 h-6" />
            </a>
            <a href={profile.insta} className="text-white hover:text-blue-400 transition-colors duration-300 transform hover:scale-110">
